...
| **Ownership** | Progress data, personal records, session history | The data is *theirs*. Personal records, streaks, and improvement charts feel like a musician's logbook. |
...
- Progress visualization prioritizes *change over time* (deltas, trends) over *absolute position* (scores, levels)
...
2. **"Precision Is Warmth"** — The most caring thing the AI can do is be *specific*. Generic feedback feels hollow. "Your timing on beat 3 drifts 40ms late when you move to the F chord" is more respectful than "keep working on timing!" Specificity communicates attention.
