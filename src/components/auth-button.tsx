...
export async function AuthButton() {
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <Link
        href="/signup"
        className="inline-flex h-8 items-center bg-primary px-4 font-mono text-[11px] uppercase tracking-[0.12em] text-primary-foreground transition-all duration-150 hover:brightness-110"
      >
        Sign Up
      </Link>
    </div>
